...
function Icon({ width = "18", height = "17", color = "#FFF", type }: IconProps): JSX.Element {
	const returnIcon = useCallback(() => {
		switch (type) {
			...
			case ICON_TYPE.close:
				return (
					<svg width={width} height={height} xmlns="http://www.w3.org/2000/svg">
						<path d="M15.01.368l2.122 2.122-6.01 6.01 6.01 6.01-2.122 2.122L9 10.622l-6.01 6.01L.868 14.51 6.88 8.5.87 2.49 2.988.368 9 6.38 15.01.37z" fill={color} fillRule="evenodd" />
					</svg>
				);
			case ICON_TYPE.arrow_up:
				return (
					<svg width={width} height={height} xmlns="http://www.w3.org/2000/svg">
						<path d="M1 6l4-4 4 4" stroke="#4661E6" strokeWidth="2" fill={color} fillRule="evenodd" />
					</svg>
				);
			case ICON_TYPE.bulb:
				return (
			...
			case ICON_TYPE.plus:
				return (
					<svg width="9" height="9" xmlns="http://www.w3.org/2000/svg">
						<text transform="translate(-24 -20)" fill="#F2F4FE" fillRule="evenodd" fontFamily="Jost-Bold, Jost" fontSize="14" fontWeight="bold">
							<tspan x="24" y="27.5">
								+
							</tspan>
						</text>
